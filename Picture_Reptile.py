...
from Picture_ReptileORM import Picture_reptileORMHelper, Picture_reptile
import socket
...
class Picture_Reptile(object):
    ...
    def __init__(self,db_name,url):
        ...
        self.cur_url=url
        self.db = Picture_reptileORMHelper(db_name)
        self.db.drop_db()
        self.db.create_db()
    ...
    def saveImgContent(self):
        ...
        picName = 'static/picture/' + name + '.jpg'
        fp = open(picName, 'wb')
        fp.write(imgContent)
        fp.close()
        img_head=u"<img src="
        ...
        pic=Picture_reptile(name, imgContent, img_url)
...
def main():
    print """
        ...
        ###############################
    """
    my_spider = Picture_Reptile("flaskr.db","http://www.meizitu.com/a/5366.html")
